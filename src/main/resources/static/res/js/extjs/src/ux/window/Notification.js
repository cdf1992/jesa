...
Ext.define('Ext.ux.window.Notification', {
    ...
    style: 'text-align: center;padding: 15px 5px 15px 5px;width  : 200px;height : 80px;',
	...
	header: Ext.isDefined(window.notificationTitle),
	title: window.notificationTitle ? notificationTitle : '',
...
function jesAlert(msg,autoCloseDelay,position,width,height){
	// TODO 找不到 notificationAutoCloseDelay，临时注释
	// autoCloseDelay=/*autoCloseDelay || 不支持页面自己配置了*/ notificationAutoCloseDelay || 2000;
...
function jesErrorAlert(msg,autoCloseDelay,position,width,height){
	// TODO 找不到 notificationAutoCloseDelay4Error，临时注释
	// autoCloseDelay=/*autoCloseDelay || 不支持页面自己配置了*/ notificationAutoCloseDelay4Error || 5000;
