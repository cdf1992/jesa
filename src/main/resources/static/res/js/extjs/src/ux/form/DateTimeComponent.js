 ...
 *     });
 */
Ext.define('Ext.ux.form.DateTimeComponent', {
    ...
    alias: 'widget.datetimecomponent',
    alternateClassName: 'Ext.DateTimeComponent',
    ...
    renderTpl: [
        ...
        '</div>',
        {
            ...
            renderTodayBtn: function(values, out) {
            	...
            	Ext.DomHelper.generateMarkup(values.$comp.confirmBtn.getRenderTree(), out);
            },
    ...
    beforeRender: function () {
        ...
        if (me.showToday) {
            ...
            me.confirmBtn = new Ext.button.Button({
                ownerCt: me,
                ownerLayout: me.getComponentLayout(),
                text: Ext.String.format(me.confirmText, '确定'),
                tooltip: Ext.String.format(me.confirmTip, '确定'),
                tooltipType: 'title',
                handler: me.selectConfirm,
                scope: me
            });
        }
    ...
    selectedUpdate: function(date){
        ...
        for (c = 0; c < cLen; c++) {
            cell = Ext.fly(cellItems[c]);
            if (Math.abs(cell.dom.firstChild.dateValue - t) < 24*60*60*1000) {
