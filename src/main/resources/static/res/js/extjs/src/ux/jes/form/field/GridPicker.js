 ...
 */
Ext.define('Ext.ux.jes.form.field.GridPicker', {
	...
	,requires: [
		'Ext.grid.Panel'
		,'Ext.ux.jes.form.field.GridPickerKeyNav'
	]
...
//		}
		...
		,initComponent: function() {
			...
			Ext.each(this.query('pagingtoolbar'), function(pagingToolbar){
...
//	,multiSelect: false
	...
	,onExpand: function() {
		...
		if (keyNav) {
			...
			keyNav = me.listKeyNav = Ext.create('Ext.ux.jes.form.field.GridPickerKeyNav', {
				target: this.inputEl
				,forceKeyDown: true
				,pickerField: this
				,grid: this.getGrid()
